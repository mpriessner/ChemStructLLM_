...
#SBATCH --output=/projects/cc/se_users/knlr326/1_NMR_project/2_Notebooks/MMT_explainability/LLM_Structure_Elucidator/agents/scripts/logs/forward_sbatch.txt
...
INPUT_FILE="$TEMP_FOLDER/forward_reactants.txt"
