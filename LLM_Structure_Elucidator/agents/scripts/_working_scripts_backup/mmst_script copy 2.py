...
def run_improvement_cycle(config: Dict, stoi: Dict, itos: Dict, stoi_MF: Dict, itos_MF: Dict, IR_config: Dict) -> float:
    ...
    while True:
        ...
        ### Add it on purpose for better out of distribution testing (with smiles augmentation)
        ...
        max_tries = 200  # Maximum attempts to prevent infinite loops
        seed = 42  # Random seed for reproducibility
        
        # Create generator
        generator = SmilesVariationGenerator(seed=seed)
